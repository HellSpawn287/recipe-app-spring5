package hellspawn287.recipeappspring5.bootstrap;

import hellspawn287.recipeappspring5.domain.*;
import hellspawn287.recipeappspring5.repositories.CategoryRepository;
import hellspawn287.recipeappspring5.repositories.RecipeRepository;
...
public class Bootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        List<Recipe> recipes = new ArrayList<>(); // ArrayList<>(2) ??
...
//      get Categories
        ...
        Optional<Category> japanCategoryOptional = categoryRepository.findByDescription("Japan");
        if (!japanCategoryOptional.isPresent()) {
            throw new RuntimeException("Expected Category not found");
        }
        ...
        Category japanCategory = japanCategoryOptional.get();
...
//        could add helper method, and make this simpler.
...
//        Now bi-directional method is used
